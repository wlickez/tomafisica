...
Public Class cls_Data
    Public Shared Function f_adminCostos(_empresa As Integer, _nombreUsuario As String) As Boolean
        ...
        End Using
    End Function
    Public Shared Function f_loginUsuario(_nombreUsuario As String, _claveUsuario As String, _formulario As Form) As Boolean
        Dim valorDevuelto As Boolean
        Using conexionBD As New SqlConnection(My.Settings.MiCadenaConexion.ToString)
            Try
                conexionBD.Open()
                'MsgBox(conexionBD.ConnectionTimeout)
                Dim comangoLogin As New SqlCommand("select dbo.FCN_LOGIN (@nombreUsuario, @claveUsuario)", conexionBD)
    ...
    End Function
    Public Shared Function f_cosultaDatosUsuario(_empresa As Integer, _usuario As String, _frm As Form) As Boolean
        Using conexionBD As New SqlConnection(My.Settings.MiCadenaConexion.ToString)
            Try
                conexionBD.Open()
                Dim cmd As New SqlCommand("select * FROM dbo.DATOS_USUARIO(@empresa, @usuario)", conexionBD)
        ...
        End Using
    End Function
    Public Shared Function f_cosultaDatosUsuarioAdministrador(_empresa As Integer, _usuario As String, _frm As Form) As Boolean
        Using conexionBD As New SqlConnection(My.Settings.MiCadenaConexion.ToString)
            Try
                conexionBD.Open()
                Dim cmd As New SqlCommand("select * FROM [dbo].[DATOS_USUARIO_ADMINISTRADOR](@empresa, @usuario)", conexionBD)
        ...
        End Using
    End Function
    Public Shared Function f_consultarProducto(_empresa As Integer, _sucursal As Integer, _descripcion As String, _codigo As String, txtCodigo As TextBox, txtDescripcion As TextBox) As Boolean
        ...
        End Using
    End Function
    Public Shared Function f_crudTomaFisicaMaestro(_empresa As Integer, _numero As Integer, _fecha As Date, _observaciones As String, _estatus As String, _usuario As String, _fechaanulacion As Date, _sucursal As Integer, _tipoop As Integer) As Boolean
        ...
        End Using
    End Function
    Public Shared Function f_crudCostos(_codigoProducto As String, _bodega As Integer, _costo As Double, _tipoop As Integer) As Boolean
        Using conexion As New SqlConnection(My.Settings.MiCadenaConexion.ToString)
            conexion.Open()
            Dim tran As SqlTransaction
        ...
        End Using
    End Function
    Public Shared Function f_crudTomaFisicaDetalle(_numero As Integer, _codigoProducto As String, _tipo As Integer, _empresa As Integer, _cantidadFisica As Integer, _sucursal As Integer, _tipoop As Integer, _posicion As Integer, _fecha As Date) As Boolean
        Using conexion As New SqlConnection(My.Settings.MiCadenaConexion.ToString)
            conexion.Open()
            Dim tran As SqlTransaction
